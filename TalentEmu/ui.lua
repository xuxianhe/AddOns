...
-->		constant
	local TUISTYLE = {
		...
		TreeFrameXToBorder = 0,
		TreeFrameYToBorder = 0,
		TreeFrameHeaderYSize = 0,
		TreeFrameFooterYSize = 20,
		TreeFrameSeqWidth = 1,
		TreeFrameLabelBGTexCoord = { 0.05, 0.95, 0.05, 0.95, },
		TreeNodeSize = 49 - DT.MAX_NUM_TIER,
		TreeNodeXGap = (31 - DT.MAX_NUM_TIER) / 2,
		TreeNodeYGap = (31 - DT.MAX_NUM_TIER) / 2,
		TreeNodeXToBorder = 12,
		TreeNodeYToTop = (31 - DT.MAX_NUM_TIER) / 2,
