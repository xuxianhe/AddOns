...
L["Only enable logging while in a raid instance."] = "레이드 인스턴스에 있는 동안에만 기록을 활성화합니다."
...
L["Stored logs (%s / %s) - Click to delete"] = "저장된 기록 (%s / %s) - 삭제는 클릭"
L["Transcriptor"] = "Transcriptor"
