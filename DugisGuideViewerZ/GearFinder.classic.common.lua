...
local scrollBarX = scrollTopX - 17
local scrollBarY = scrollTopY - 43
...
function GearFinderModule:Initialize()
    ...
    local buttonFrame = GUIUtils:AddButton(PaperDollFrame, "", ZygorGuidesViewer and 252 or 285, -44, 23, 23, 23, 23, function(self) 
        if DGF.shown then
            HideGF()
        else
            ShowGF()
...
function DGF:InitializeGearFinderUI()
  ...
  --  parent:SetSize(mainFrameWidth, mainFrameHeight)
    ...
    CreateFrame("ScrollFrame", "DugisGearFinderFrame", parent, "ScrollFrameTemplate")
    ...
    --[[DugisGearFinderFrame.Top:SetHeight(319)
    DugisGearFinderFrame.Top:ClearAllPoints()
    DugisGearFinderFrame.Top:SetPoint("TOPRIGHT",  scrollTopX, scrollTopY)
    DugisGearFinderFrame.Bottom:ClearAllPoints()
    DugisGearFinderFrame.Bottom:SetPoint("TOPRIGHT",  scrollBottomX, scrollBottomY)]]
    DugisGearFinderFrame.ScrollBar:ClearAllPoints()
    DugisGearFinderFrame.ScrollBar:SetPoint("TOPRIGHT",  scrollBarX, scrollBarY)
    DugisGearFinderFrame.ScrollBar:SetHeight(scrollBarHeight)
    DugisGearFinderFrame.ScrollBar:SetWidth(15)
