...
Private.event_prototypes = {
  ...
  ["Power"] = {
    ...
    internal_events = function(trigger)
      ...
      if WeakAuras.IsWrathOrCata() and trigger.unit == "player" and trigger.use_powertype and trigger.powertype == 26 then
        tinsert(result, "ECLIPSE_DIRECTION_CHANGE");
      end
      if WeakAuras.IsWrathOrCata() and trigger.unit == "player" and trigger.use_powertype and trigger.powertype == 4 then
    ...
    args = {
      ...
      },
      {
        ...
        store = true,
        enable = function(trigger)
          return WeakAuras.IsWrathOrCata() and trigger.unit == "player" and trigger.use_powertype and trigger.powertype == 26
        end,
      },
      {
        name = "power",
  ...
  ["Weapon Enchant"] = {
    ...
    init = function(trigger)
      ...
      local ret = [[
        ...
        elseif triggerWeaponType == "ranged" and WeakAuras.IsWrathOrCata() then
  ...
  ["Character Stats"] = {
    ...
    args = {
      ...
      },
      {
        ...
        display = L["Mastery (%)"],
        type = "number",
        init = "WeakAuras.IsWrathOrCata() and GetMastery() or GetMasteryEffect()",
        store = true,
        enable = WeakAuras.IsWrathOrCataOrRetail(),
        conditionType = "number",
        hidden = not WeakAuras.IsWrathOrCataOrRetail(),
      ...
      },
      {
        ...
        enable = WeakAuras.IsClassicEraOrWrathOrCata(),
        hidden = not WeakAuras.IsClassicEraOrWrathOrCata(),
      },
      {
        type = "header",
