...
https://github.com/WeakAuras/WeakAuras2/wiki/Custom-Triggers#events]=] ] = "|cFFFF0000不推荐使用未过滤的 COMBAT_LOG_EVENT_UNFILTERED|r 不带过滤器的 COMBAT_LOG_EVENT_UNFILTERED 已被禁用，因为它对性能影响很大。更多信息：https://github.com/WeakAuras/WeakAuras2/wiki/Custom-Triggers#events"
