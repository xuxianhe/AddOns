...
https://github.com/WeakAuras/WeakAuras2/wiki/Protected-Frames]=] ] = [=[전투중에는 보호중인 프레임을 변경할 수 없습니다. 자세한 정보:
...
L["Empowered Cast Fully Charged"] = "강화 시전 완전 충전 완료"
L["Empowered Fully Charged"] = "강화 시전 완전 충전"
L["Empty"] = "비었을 때"
...
https://github.com/WeakAuras/WeakAuras2/wiki/Protected-Frames]=] ] = [=['%s' 오류가 보호 코드의 복제품을 생성했습니다. 이 위크오라는 삭제할 것을 권장합니다. 자세한 정보:
https://github.com/WeakAuras/WeakAuras2/wiki/Protected-Frames]=]
...
L["Resting"] = "휴식 중"
L["Resurrect"] = "부활"
L["Resurrect Pending"] = "부활 수락 대기 상태"
L["Right"] = "오른쪽"
...
https://github.com/WeakAuras/WeakAuras2/wiki/Protected-Frames]=] ] = [=[보호 중인 프레임을 감지했습니다. 자세한 정보:
https://github.com/WeakAuras/WeakAuras2/wiki/Protected-Frames]=]
...
L["Show charged duration for empowered casts"] = "강화 시전의 충전 지속시간 표시"
...
L["Subtract GCD"] = "글로벌 쿨타임 차감"
L["Subzone Name"] = "하위지역 이름"
L["Success"] = "성공"
L["Sulfuron Harbinger"] = "설퍼론 사자"
L["Summon"] = "소환"
L["Summon Pending"] = "소환 수락 대기 상태"
L["Sun"] = "태양"
