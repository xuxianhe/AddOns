	...
	Pages = {
		...
		[2] = function()
			...
			_G.PluginInstallFrame.Option1:SetScript('OnClick', function()
				...
				if (E.Retail or E.Cata or E.Wrath or E.ClassicSOD) and E.data:IsDualSpecEnabled() then
			...
			_G.PluginInstallFrame.Option2:SetScript('OnClick', function()
				...
				ElvUI_EltreumUI:Print(L["ElvUI Chat has been set."])
				if (E.Retail or E.Cata or E.Wrath) and E.data:IsDualSpecEnabled() then
		...
		[7] = function()
			...
			if (not IsAddOnLoaded("Questie")) and (E.Cata or E.Wrath or E.Classic) then
				_G.PluginInstallFrame.SubTitle:SetFormattedText("|cffff0000"..L["WARNING"])
			...
			if not IsAddOnLoaded("Gladdy") and (E.Cata or E.Wrath) and not IsAddOnLoaded("Gladius") then
				_G.PluginInstallFrame.SubTitle:SetFormattedText("|cffff0000"..L["WARNING"])
			...
			if (E.Cata or E.Wrath) and ((not IsAddOnLoaded("Questie")) and (not IsAddOnLoaded("DBM-Core")) and (not IsAddOnLoaded("BigWigs")) and (not IsAddOnLoaded("Gladdy")) and (not IsAddOnLoaded("Gladius"))) then
				_G.PluginInstallFrame.Desc4:SetText('|cffff0000'..L["You have none of these addons installed or enabled"]..'|r')
			end
		end,
		[8] = function()
