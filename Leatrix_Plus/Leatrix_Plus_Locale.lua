----------------------------------------------------------------------
-- 	Leatrix Plus Locale for Cataclysm Classic
----------------------------------------------------------------------
...
L["Hide raid group labels"] = "Ocultar etiquetas de grupo de banda"
...
L["If checked, traveling merchant greetings and farewells will be muted.|n|nThis applies to Traveler's Tundra Mammoth."] = "Si está seleccionado, los saludos y despedidas de los comerciantes viajeros serán silenciados. Esto se aplica al Mamut de tundra de viajero."
...
L["Hide raid group labels"] = "Cacher les étiquettes de groupe de raid"
...
L["Hide raid group labels"] = "Ocultar etiquetas do grupo de raide"
