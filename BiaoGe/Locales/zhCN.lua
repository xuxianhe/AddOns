...
do --简体说明书
    ns.instructionsText = {
        ...
        [[-历史价格：现在会显示全账号价格（需要同步模块）]],
        [[-优化皮肤美化效果]],
        [[-拍卖记录界面和装备过期界面的高度现在会跟主界面一致]],
        [[-<WLK>通报WCL：适配TOC]],
        [[-<WLK>现在会自动记录TOC掉落的图纸]],
        [[-<WLK>修复了泰坦精钢锭CD不记录的问题]],
        " ",
        "|cff00FF00" .. [[2月19日更新v1.14.7]],
        [[-角色总览：增加选项"布局方式"]],
        [[-游戏快捷键设置：增加打开/关闭角色总览]],
        [[-修复了角色总览显示全服务器角色时，相同名字的角色只显示了一个的问题]],
        [[-<60服>[萨弗隆铁锭]现在会被自动记录了，之前错误地写进了黑名单。。]],
        [[-<60服>AQL和TAQ表格的杂项格子增加，并且现在自动记录[雕像]和[钥匙] ]],
        [[-<60服>NAXX表格，现在自动记录[护甲碎片]和[溶解之语] ]],
        " ",
        "|cff00FF00" .. [[2月17日更新v1.14.6]],
        [[-角色总览：增加选项"默认显示是当前服务器角色还是全服务器角色"]],
        [[-修复了角色总览显示全服务器角色时，任务和专业CD显示错误的问题]],
        " ",
        "|cff00FF00" .. [[2月16日更新v1.14.5]],
        [[-角色总览：现在可以使用快捷命令直接打开/BGR]],
        [[-角色总览：现在长按SHIFT可以显示全服务器角色]],
        [[-<60服>角色总览：副本的英文缩写改成了中文缩写]],
        [[-<60服>调整MC表格的布局，杂项格子增加到13个]],
        " ",
        "|cff00FF00" .. [[2月15日更新v1.14.4]],
        [[-优化交易自动摆放装备的逻辑，减少偶尔会漏放的情况]],
        [[-角色总览：现在CTRL+左键可以把面板固定显示出来]],
        [[-<WLK>角色总览：副本的英文缩写改成了中文缩写]],
    }
    ...
    ns.VIPinstructionsText = {
        ...
        "|cffFFFFFF-批量邮寄工资：",
        "可以给全团或者部分团员批量邮寄金币，再也不用逐个邮寄这么麻烦。",
        "|cffFFFFFF-邮件记录：",
        "记录你的所有邮件详情。特别是在使用批量邮寄工资时，可以翻查记录。",
        "|cffFFFFFF-交易记录：",
        "类似TradeLog插件的一个交易记录功能，但功能更全面。",
        "|cffFFFFFF-预设起拍价：",
        "提前设定每个装备的自动拍卖起拍价，ALT+右键点击表格/背包/聊天框装备时，直接按预设价开拍。",
        "|cffFFFFFF-进组欢迎语：",
        "在团员进组时，自动密语对方你的YY号、团队规则等。",
        "|cffFFFFFF-查看YY评价者：",
        "含有具体理由的YY评价，现在会在其理由后面显示其评价者名称。",
        "没有具体理由的，则不会显示。",
        " ",
        "|cff00ff00点击右下角爱发电按钮了解详情。",
    }
