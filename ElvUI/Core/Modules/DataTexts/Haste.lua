...
local function OnEnter()
	...
	local rating = ((E.Cata or E.Wrath) and E.myclass == 'HUNTER' and CR_HASTE_RANGED) or CR_HASTE_MELEE
...
local function OnEvent(self)
	local haste = (E.Cata or E.Wrath) and ((E.myclass == 'HUNTER' and GetRangedHaste()) or GetMeleeHaste()) or GetHaste()
...
DT:RegisterDatatext('Haste', STAT_CATEGORY_ENHANCEMENTS, (E.Cata or E.Wrath) and { 'UNIT_STATS', 'UNIT_ATTACK_SPEED' } or { 'UNIT_STATS', 'UNIT_SPELL_HASTE', 'UNIT_AURA' }, OnEvent, nil, nil, not E.Classic and OnEnter, nil, STAT_HASTE, nil, ApplySettings)
