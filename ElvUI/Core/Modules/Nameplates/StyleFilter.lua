...
function NP:StyleFilterConditionCheck(frame, filter, trigger)
	...
	-- Player Vehicle
	if (E.Retail or E.Cata or E.Wrath) and (trigger.inVehicle or trigger.outOfVehicle) then
		local inVehicle = UnitInVehicle('player')
		if (trigger.inVehicle and inVehicle) or (trigger.outOfVehicle and not inVehicle) then passed = true else return end
	end

	-- Unit Vehicle
	if (E.Retail or E.Cata or E.Wrath) and (trigger.inVehicleUnit or trigger.outOfVehicleUnit) then
...
function NP:StyleFilterVehicleFunction(_, unit)
	...
	self.inVehicle = (E.Retail or E.Cata or E.Wrath) and UnitInVehicle(unit) or nil
end
