...
P.general = {
	...
	totems = { -- totem tracker
		...
		sortDirection = ((E.Cata or E.Wrath) and 'DESCENDING') or 'ASCENDING',
		size = 40,
		height = 40,
		spacing = 4,
		keepSizeRatio = true,
...
P.nameplates.units.ENEMY_NPC.debuffs.priority = 'Blacklist,blockNoDuration,Personal,CCDebuffs'
...
P.unitframe.units.target.debuffs.priority = 'Blacklist,Friendly:Dispellable,Personal,CCDebuffs'
...
P.actionbar.bar1.paging.ROGUE = '[bonusbar:1] 7;'..((E.Cata or E.Wrath) and ' [bonusbar:2] 8;' or '')
P.actionbar.bar1.paging.WARLOCK = (E.Cata or E.Wrath) and '[form:1] 7;' or nil
