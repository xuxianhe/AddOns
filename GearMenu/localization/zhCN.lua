...
if (GetLocale() == "zhCN") then
  ...
  -- about
  rggm.L["author"] = "Author: Michael Wiesendanger |cff99ddff谷|r|cff88ccee风|r|cff77bbdd@|r|cff66aaccD|r|cff5599bbo|r|cff4488aau|r|cff00aaffY|r|cff0099ffi|r|cff0088ffn|r"
  ...
  rggm.L["issues"] = "KOOK社区: https://kook.vip/lL0shE"
  ...
  rggm.L["choose_theme"] = "选择主题:"
  rggm.L["theme_classic"] = "经典"
  rggm.L["theme_custom"] = "自定义"
  rggm.L["theme_change_confirmation"] = "这将重新加载你的界面。你想要继续吗?"
  rggm.L["theme_change_confirmation_yes"] = "是"
  rggm.L["theme_change_confirmation_no"] = "否"
  ...
  rggm.L["trinket_menu_title"] = "Trinket Menu 配置"
  rggm.L["enable_trinket_menu"] = "启用 TrinketMenu"
  rggm.L["enable_trinket_menu_tooltip"] = "是否启用和显示 TrinketMenu 或不"
  rggm.L["window_lock_trinket_menu"] = "锁定 TrinketMenu"
  rggm.L["window_lock_trinket_menu_tooltip"] = "防止 TrinketMenu 框架移动"
  rggm.L["shoow_cooldowns_trinket_menu"] = "显示冷却"
  rggm.L["shoow_cooldowns_trinket_menu_tooltip"] = "显示所有物品槽的冷却"
  rggm.L["trinket_menu_column_amount_slider_title"] = "列"
  rggm.L["trinket_menu_column_amount_slider_tooltip"] = "TrinketMenu 中使用的列数"
  rggm.L["trinket_menu_slot_size_slider_title"] = "槽大小"
  rggm.L["trinket_menu_slot_size_slider_tooltip"] = "TrinketMenu 中一个槽的大小"
